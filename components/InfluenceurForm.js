...
function InfluenceurForm({navigation}){

    const initInfluenceurData = {
        id:null,
        nom:"",
        email:"",
        telephone:"",
    ...
    //Creer un Influenceur dans db.json let Influenceur = Objet initInfluenceurData
    const [Influenceur, setInfluenceur] = useState(initInfluenceurData);
    ...
    const onSubmit =  data => {
        ...
        axios.post("http://localhost:3000/influenceur", data)
            .then(response => {
            ...
            .catch(err => {
                console.log("Erreur lors de la creation du profil Influenceur ! " + err);
            });
    }
...
export default InfluenceurForm